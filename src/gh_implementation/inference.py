...
model1 = Seq2Seq(input_dim=cfg['input_dim']
                ...
                , enc_rnn_layers=inf_cfg['enc_rnn_layers'][0]
                , conv_layers=inf_cfg['conv_layers'][0]
                , kernel_dim=inf_cfg['kernel_dim'][0]
                , stride=inf_cfg['stride'][0]
                , nchannels=inf_cfg['conv_channels'][0]
                , enc_dropout=inf_cfg['enc_dropout'][0]
                , enc_norm_type=inf_cfg['enc_norm_type'][0]
                , enc_use_bias=inf_cfg['enc_use_bias'][0]
                , enc_init_weights=inf_cfg['enc_init_weights'][0]
                , dec_use_bias=inf_cfg['dec_use_bias'][0]
                , dec_dropout=inf_cfg['dec_dropout'][0]
                , dec_norm_type=inf_cfg['dec_norm_type'][0]
                , dec_init_weights=inf_cfg['dec_init_weights'][0]
                , orthogonal_init=inf_cfg['orthogonal_init'][0]
                , use_se=inf_cfg['use_se'][0]
                , use_pyramid=inf_cfg['use_pyramid'][0]
                , lock_drop=inf_cfg['lock_drop'][0]
                )
