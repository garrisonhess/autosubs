...
knnw_subtitle_processed_path = os.path.expanduser(cfg['knnw_subtitle_processed_path'])
knnw_subtitle_wav2vec_processed_path = os.path.expanduser(cfg['knnw_subtitle_wav2vec_processed_path'])
wav_folder = os.path.expanduser(cfg['wav_folder'])
vec2wav_npy = os.path.expanduser(cfg['vec2wav_npy'])
...
print("knnw_subtitle_wav2vec_processed_path", knnw_subtitle_wav2vec_processed_path)